...
jan = Tk()
jan.title("Securitech - Área do Usuário")
...
logo = PhotoImage(file="icones/pngegg.png")

LeftFrame = Frame(jan, width=197, height=300, bg="BLACK", relief="raise")
LeftFrame.pack(side=LEFT)

RightFrame = Frame(jan, width=400, height=300, bg="BLACK", relief="raise")
RightFrame.pack(side=RIGHT)

LogoLabel = Label(LeftFrame, image=logo, bg="BLACK")
LogoLabel.place(x=50, y=100)

UserLabel = Label(RightFrame, text="Usuário: ", font=("Century Gothic", 20), bg="BLACK", fg="White")
UserLabel.place(x=5, y=100)

UserEntry = ttk.Entry(RightFrame, width=30)
UserEntry.place(x=150, y=110)

PassLabel = Label(RightFrame, text="Senha:", font=("Century Gothic", 20), bg="BLACK", fg="White")
